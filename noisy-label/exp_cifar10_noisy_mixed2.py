...
w = np.eye(22)
w[11:21,11:21] = 0.4 * np.eye(10) + 0.06
...
net_trainer_noisy.train_mixed(net, 200, train_batches, test_batches)
net.adjust_learning_rate(0.1)
net_trainer_noisy.train_mixed(net, 10, train_batches, test_batches)
net.adjust_learning_rate(0.1)
net_trainer_noisy.train_mixed(net, 10, train_batches, test_batches)
save_net_cifar10.save_net(net, 'results/weights-cifar10-pure10k-noisy50k-TD-tc' + str(sys.argv[4]))
