...
def prepare_batches(train_data, test_data, batch_size):
...
train_batches, test_batches = prepare_batches(train_data, test_data, batch_size)
...
train_batches, test_batches = prepare_batches(train_data, test_data, batch_size)
train(net, num_epoch2, train_batches, test_batches)
